...
> 학습 루프 워크플로우는 이 레포에 도입하지 않았으므로, 이 파일은 **수동으로** 관리합니다.
> 리뷰 봇이 오탐을 내면 아래 형식으로 추가하세요 — 다음 리뷰부터 반영됩니다.
>
> 아직 봇 리뷰 이력이 없어 실제 오탐 기록은 없습니다. 다만 PR 코멘트 분석에서
> **오탐 위험이 확인된 룰**을 예방 차원에서 1건 미리 등록해 둡니다.
