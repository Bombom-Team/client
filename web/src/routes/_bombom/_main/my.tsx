...
import NotificationSettingsSection from '@/pages/my-page/NotificationSettingsSection';
import ProfileSection from '@/pages/my-page/ProfileSection';
import RewardsSection from '@/pages/my-page/RewardsSection';
import SubscribedNewslettersSection from '@/pages/my-page/SubscribedNewslettersSection';
