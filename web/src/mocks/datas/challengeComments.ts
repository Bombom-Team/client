import type { CommentCardProps } from '@/pages/challenge/comments/components/CommentCard';

export const challengeComments: CommentCardProps[] = [
  {
    nickname: '유다빈',
  ...
  },
  {
    ...
    createdAt: '2025-12-24T04:00:00.000Z',
    comment:
